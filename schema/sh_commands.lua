...
do
	...
	function COMMAND:OnRun(client, target)
		...
		netstream.Start(client, "ViewData", targetClient, target:GetData("cid") or false, target:GetData("empireData"))
	end
...
do
	...
	function COMMAND:OnRun(client, arguments)
		...
		netstream.Start(client, "ViewObjectives", Schema.EmpireObjectives)
	end
